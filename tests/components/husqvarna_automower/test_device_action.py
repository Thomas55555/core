"""The tests for Husqvarna Automower device actions."""
...
async def test_get_actions(
    ...
    """Test we get the expected actions from a husqvarna_automower."""
...
async def test_action(hass: HomeAssistant) -> None:
            ...
            automation.DOMAIN: [
                {
                    ...
                    "action": {
                        "domain": DOMAIN,
                        "device_id": "abcdefgh",
                        "entity_id": "husqvarna_automower.entity",
                        "type": "turn_off",
                    },
                },
                {
    ...
    turn_off_calls = async_mock_service(hass, "husqvarna_automower", "turn_off")
    turn_on_calls = async_mock_service(hass, "husqvarna_automower", "turn_on")
